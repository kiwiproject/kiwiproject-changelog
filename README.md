...
Both the revision and the previous revision must be specified. The reason is that so that
the changelog generator can find the unique _commit_ authors between these two revisions,
